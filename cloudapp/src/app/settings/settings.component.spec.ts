...
describe('SettingsComponent', () => {
  ...
  beforeEach(() => {
    ...
    settingsService = TestBed.inject(CloudAppSettingsService) as jasmine.SpyObj<CloudAppSettingsService>;
  /*  spy = spyOn<any>(settingsService, 'get').subscribe.and.callFake(() => {
